...
strategy = sys.argv[4]
refSize = sys.argv[5]
percentageImport_k = sys.argv[6] if len(sys.argv) > 5 else 0
percentageImport_bm = sys.argv[7] if len(sys.argv) > 6 else 0

os.chdir(refSize + "/" + strategy + "_import/")

print("Creating directory " + scenarioHome + scenarioImport + str(rep) + "_" + str(percentageImport_bm))
if not os.path.isdir(scenarioHome + scenarioImport + str(rep) + "_" + str(percentageImport_bm)):
    os.makedirs(scenarioHome + scenarioImport + str(rep) + "_" + str(percentageImport_bm))
SelectionDir = scenarioHome + scenarioImport + str(rep) + "_" + str(percentageImport_bm) + "/"
