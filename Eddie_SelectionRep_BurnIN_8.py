...
for rep in [REP]:
    if not os.path.isdir("FillInBurnIn" + str(rep) + str(8)):
        os.makedirs("FillInBurnIn" + str(rep) + str(8))
    os.chdir("FillInBurnIn" + str(rep) + str(8)) #prestavi se v FillInBurnin za ta replikat
