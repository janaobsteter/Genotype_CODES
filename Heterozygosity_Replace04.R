...
for (rep in 0:4) {
    ...
    M <- readr::read_table(paste0("/home/v1jobste/JanaO/_strategy_/_scenario_", rep, "/SimulatedData/AllIndividualsSnpChips/Last20Gen.txt"),
    ...
    write.csv(MeanHet, paste0("/home/v1jobste/JanaO/Heterozygosity/MeanHET__strategy___scenario__Rep", rep, ".csv"), quote=FALSE)
}
