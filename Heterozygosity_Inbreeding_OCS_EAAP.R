...
hetDF <- hetDF[hetDF$Group %in% c("SU55PT","SU55GS", "SU51GS", "SU15GS", "OCS15", "OCS30", "OCS45", "OCS60", "OCS75"),]
...
HETa$Strategy <- factor(HETa$Strategy, levels =c("SU55", "SU51", "SU15", "OCS"))
...
############################################################
HET$Group <- factor(HET$Group, level=c("SU55PT","SU55GS","SU51GS","SU15GS", "OCS15","OCS30","OCS45","OCS60","OCS75"))
