...
if not os.path.isdir(scenario + str(rep) + str(4)):
	os.makedirs(scenario + str(rep) + str(4))
SelectionDir = scenario + str(rep) + str(4) + "/"
...
os.system('cp -r ' + WorkingDir + '/FillInBurnIn' + str(rep) + str(4) +  '/* .')
