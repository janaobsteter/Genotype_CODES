...
if not os.path.isdir(scenario + str(rep) + str(12)):
	os.makedirs(scenario + str(rep) + str(12))
SelectionDir = scenario + str(rep) + str(12) + "/"
...
os.system('cp -r ' + WorkingDir + '/FillInBurnIn' + str(rep) + str(12)+ '/* .')
