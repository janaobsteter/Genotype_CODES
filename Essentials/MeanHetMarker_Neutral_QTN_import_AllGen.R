...
for (gen in 20:40) {
  ...
  system(paste0("head -n", 8640*2*gen, " ./AllIndividualsSnpChips/Chip2Genotype.txt | tail -n17280 | head -n8640 > ./AllIndividualsSnpChips/CurrentGeno1.txt"))
  system(paste0("head -n", 8640*2*gen, " ./AllIndividualsSnpChips/Chip2Genotype.txt  | tail -n8640 > ./AllIndividualsSnpChips/CurrentGeno2.txt"))
  ...
  #še za QTN
  system(paste0("head -n", 8640*2*gen, " ./UnrestrictedQtnIndivGenotypes.txt | tail -n17280 | head -n8640 > ./CurrentQTN1.txt"))
  system(paste0("head -n", 8640*2*gen, " ./UnrestrictedQtnIndivGenotypes.txt | tail -n8640 > ./CurrentQTN2.txt"))
