...
TGVsOCS1 <- read.csv("~/Documents/PhD/Projects/inProgress/GenomicStrategies_SireUse/Results//TGVsAll_OCS_19032019.csv", sep=" ")
...
for (strategy in c("SU55", "SU51", "SU15", "SU52", "SU53", "SU54", "OCS")) {
  for (scenario in c("PT", "GS-PS", "GS-C", "GS-BD", "GS", 15, 30, 45, 50, 55, 60, 75)) {
    for (rep in 0:19) {
...
for (scenario in c("PT","GS", 15, 30, 45, 50, 55, 60, 75)) {
  for (rep in 0:9) {
    #genetic gain
...
#OCS60 <- tgv60[tgv60$scenario %in% c("PT","GS", 15,

OCS60 <- tgv60[tgv60$PlotGroup %in% c("SU55PT","SU55GS", "SU51GS","SU52GS","SU53GS","SU54GS", "OCS15", "OCS30", "OCS45","OCS50","OCS55", "OCS60", "OCS75"),]
...
for (plotgroup in c("SU55PT","SU55GS", "SU51GS",  "SU52GS",  "SU53GS",  "SU54GS", "OCS15", "OCS30", "OCS45","OCS50","OCS55", "OCS60", "OCS75")) {
...
avgSlope <- summarySE(regRep, measurevar="Slope", groupvars=c("Strategy", "Scenario"), na.rm=TRUE)[,c(1,2,4,5)]
colnames(avgSlope) <- c("Strategy", "Scenario", "Slope", "SlopeSD")
...
avgReg <- merge(avgSlope, avgInt, by=c("Strategy", "Scenario"))
...
EFF$Name <- factor(EFF$Name, level=c("SU55PT","SU55GS","SU51GS","SU52GS","SU53GS","SU54GS","OCS15","OCS30","OCS45","OCS50","OCS55","OCS60","OCS75"))
...
OCS60$scenario <- factor(OCS60$scenario, levels =c("PT", "GS", 15,30,45,50, 55,60,75))
MEAN60_OCS$Scenario <- factor(MEAN60_OCS$Scenario, levels =c("PT", "GS", 15,30,45,50, 55,60,75))
MEAN60_OCS$Strategy <- factor(MEAN60_OCS$Strategy, levels =c("SU55", "SU51","SU52","SU53","SU54",  "OCS"))
MEAN60_OCS_abs$Scenario <- factor(MEAN60_OCS_abs$Scenario, levels =c("PT", "GS", 15,30,45,50,55,60,75))
MEAN60_OCS_abs$Strategy <- factor(MEAN60_OCS_abs$Strategy, levels =c("SU55", "SU51", "SU52","SU53","SU54",  "OCS"))
OCS60$scenario <- factor(OCS60$scenario, levels =c("PT", "GS", 15,30,45,50,55,60,75))
OCS60$Strategy <- factor(OCS60$Strategy, levels =c("SU55", "SU51", "SU15","SU52","SU53","SU54", "OCS"))
EFF$Scenario <- factor(EFF$Scenario, levels =c("PT", "GS", 15,30,45,50,55,60,75))
EFF$Strategy <- factor(EFF$Strategy, levels =c("SU55", "SU51", "SU15", "SU52","SU53","SU54", "OCS"))

OCS60$Name <- paste0(OCS60$Strategy, OCS60$scenario)
OCS60$Name <- factor(OCS60$Name, level=c("SU55PT","SU55GS","SU51GS","SU52GS","SU53GS","SU54GS","OCS15","OCS30","OCS45","OCS50","OCS55","OCS60","OCS75"))
...
maxminOS <- maxmin[maxmin$scenario %in% c(15, 30, 45, 50, 55, 60, 75, "PT", "GS"),]
...
maxminPT <- maxminOS[maxminOS$PlotGroup %in% c("SU55PT", "SU55GS", "SU51GS", "SU52GS", "SU53GS", "SU54GS"),]
maxminOCS <- maxminOS[maxminOS$scenario %in% c(15, 30, 45, 50, 55, 60, 75),]
...
TGVsStrategy <- TGVsAll[TGVsAll$PlotGroup %in% c("SU55PT", "SU55GS", "SU51GS", "SU52GS", "SU53GS", "SU54GS", "OCS15", "OCS30", "OCS45", "OCS50", "OCS55", "OCS60", "OCS75"),]
TGVsStrategy$strategy <- factor(TGVsStrategy$strategy, levels =c("SU55", "SU51","SU52","SU53","SU54", "OCS"))
TGVsStrategy$scenario <- factor(TGVsStrategy$scenario, levels =c("PT","GS", 15, 30, 45, 50, 55, 60, 75))
TGVsStrategy$PlotGroup <- factor(TGVsStrategy$PlotGroup, level= c("SU55PT", "SU55GS", "SU51GS",  "SU52GS", "SU53GS", "SU54GS", "OCS15", "OCS30", "OCS45", "OCS50", "OCS55", "OCS60", "OCS75"))
...
# TGVsStrategy <- TGVsStrategy[order(TGVsStrategy$PlotGroup),]
maxminPT$PlotGroup <- factor(maxminPT$PlotGroup, level=c("SU55PT", "SU55GS","SU51GS","SU52GS", "SU53GS", "SU54GS", "SU15PT"))
maxminPT <- maxminPT[order(maxminPT$PlotGroup),]
maxminOCS$PlotGroup <- factor(maxminOCS$PlotGroup, level=c("OCS15", "OCS30", "OCS45","OCS50", "OCS55", "OCS60", "OCS75"))
...
maxminOS$scenario <- as.factor(as.character(maxminOS$scenario))
 ...
 TGVsStrategy <- TGVsStrategy[TGVsStrategy$scenario %in% c(15, 30, 45, 50, 55, 60, 75, "PT", "GS"),]
 TGVsStrategy <- TGVsStrategy[TGVsStrategy$scenario %in% c(15, 30, 45, 60, 75, "PT", "GS"),]
 ...
 ggplot(data = TGVsStrategy, aes(x=SDGenicSt, y=zMeanGenic, group=group, colour=PlotGroup)) +
   ...
   scale_linetype_manual("Breeding program",
                         breaks=c("OCS15", "OCS30", "OCS45","OCS60", "OCS75","SU55PT", "SU55GS", "SU51GS",  "SU52GS", "SU53GS", "SU54GS"),
                         ...
                         labels=c(expression("OCS"["15"]), expression("OCS"["30"]), expression("OCS"["45"]),
                                  ...
                                  "5 sires/year, use 2 years, GS", "5 sires/year, use 3 years, GS", "5 sires/year, use 4 year, GS")) +
...
#vse OCS
 ggplot(data = TGVsStrategy, aes(x=SDGenicSt, y=zMeanGenic, group=group, colour=PlotGroup)) +
   ...
   ylim(0,7) + coord_cartesian(xlim = c(1, 0.75)) + theme_bw() +
   scale_linetype_manual("Breeding program",
                         breaks=c("OCS15", "OCS30", "OCS45", "OCS50", "OCS55","OCS60", "OCS75","SU55PT", "SU55GS", "SU51GS",  "SU52GS", "SU53GS", "SU54GS"),
...
MeanAverage <- MeanAverage[MeanAverage$PlotGroup %in% c("OCS15", "OCS30", "OCS45", "OCS60", "OCS75","SU55PT", "SU55GS", "SU51GS"),]
MeanAverage$PlotGroup <- factor(MeanAverage$PlotGroup, level=c("OCS15", "OCS30", "OCS45", "OCS60", "OCS75","SU55PT", "SU55GS", "SU51GS"))

gen60 <- TGVsAll[TGVsAll$Generation==60,]
gen60 <- summarySE(data=gen60, measurevar = "zMean", groupvars = c("Strategy", "scenario"))

gen60[gen60$Strategy=="SU51" & gen60$scenario=="GS",]
MeanAverage[MeanAverage$Strategy=="SU51" & MeanAverage$scenario=="GS" & MeanAverage$Generation==60,]
...
MeanAverageSD <- MeanAverageSD[MeanAverageSD$PlotGroup %in% c("OCS15", "OCS30", "OCS45", "OCS60", "OCS75","SU55PT", "SU55GS", "SU51GS"),]
MeanAverageSD$PlotGroup <- factor(MeanAverageSD$PlotGroup, level=c("OCS15", "OCS30", "OCS45", "OCS60", "OCS75","SU55PT", "SU55GS", "SU51GS"))

MeanAverageSDGenic$PlotGroup <- paste0(MeanAverageSDGenic$Strategy, MeanAverageSDGenic$scenario)
MeanAverageSDGenic <- MeanAverageSDGenic[MeanAverageSDGenic$PlotGroup %in% c("OCS15", "OCS30", "OCS45", "OCS60", "OCS75","SU55PT", "SU55GS", "SU51GS"),]
MeanAverageSDGenic$PlotGroup <- factor(MeanAverageSDGenic$PlotGroup, level=c("OCS15", "OCS30", "OCS45", "OCS60", "OCS75","SU55PT", "SU55GS", "SU51GS"))
