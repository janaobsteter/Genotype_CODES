...
TGVsAll <- data.frame()
for (rep in 0:9) {
  for (repeats in c(1, 2, 5, 8, 9, 10)) {
	  for (scenario in c("1_1", "1_2", "2_1")) {
	    WorkingDir = paste0("/home/v1jobste/JanaO/10K/SU55_permEnv/Gen",rep, "_False", repeats, "_", scenario, "/SimulatedData/")
...
write.table(TGVsAll, paste0("TGVsAll_phenoFalse_",  date, ".csv"), quote=FALSE, row.names=FALSE)
