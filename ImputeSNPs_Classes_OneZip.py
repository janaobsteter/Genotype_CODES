...
# pasma="Rjava"
# AlleleFormat="top"
# zip_file="we_mr_08082018_IDB191.zip"
# merge_ask='N'
...
if not os.path.isfile(tempDir + "/" + zip_file):
    shutil.copy("/home/jana/Downloads/"+zip_file, tempDir)
...
print("FinalReport" + onePackage.finalreportname[0])
...
print(onePackage.genodate)
print(pedfile.chip)
print(pedfile.samples)
...
GenotypedInd.to_csv(path_or_buf = tempDir+str(onePackage.genodate)+'GovedoInd.csv', sep=",", index=False  )
...
# #merge all the chips needed up2dating
# if merge_ask == 'Y':
#     for i in PedFiles:
