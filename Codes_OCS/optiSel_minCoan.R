...
ContributionsMinCoancestry$parent$nOff = noffspring(ContributionsMinCoancestry$parent, N=8640)$nOff
ContributionsMinCoancestry$parent %>%
  filter(nOff > 0) %>%
  arrange(desc(nOff))


fathers <- ContributionsMinCoancestry$parent[(ContributionsMinCoancestry$parent$Sex=="male") & (ContributionsMinCoancestry$parent$nOff != 0), c("Indiv", "nOff")]
