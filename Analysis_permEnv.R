...
write.table(pheno60, "/home/jana/Documents/PhD/Projects/inProgress/Phenotyping/Results/GeneticGain_RefYes.csv", quote=FALSE, row.names=FALSE)
...
write.table(accPlot[,c("AgeCat", "NoControl", "gp", "Cor")] %>% spread(key = gp, value = Cor), 
            "/home/jana/Documents/PhD/Projects/inProgress/Phenotyping/Results/Accuracy_RefYes.csv", quote=FALSE, row.names=FALSE)
