...
print(range(0, int(rep)))

for rep in range(0, int(rep)):
	...
	ks.loc[ks.Generation.isin(range(max(ks.Generation)-6, max(ks.Generation)+1)), 'Indiv'].to_csv('/home/v1jobste/JanaO/FillInBurnIn' + str(rep) + '/IndForGeno_1K.txt', index=None, header=None, sep='\n')
