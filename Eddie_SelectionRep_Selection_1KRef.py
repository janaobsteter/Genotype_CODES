...
#sys.argv: 1 = rep, 2 = scenario, 3 = strategy
...
os.system('mv IndForGeno_1K.txt IndForGeno.txt')
...
for roundNo in range(21,41): #za vsak krog selekcije
    ...
    os.system("/exports/cmvm/eddie/eb/groups/tier2_hickey_external/R-3.4.2/bin/Rscript MeanHetChip2_Neutral.R " + str(roundNo+20) + " " + str(rep) + " " + str(scenario) + " " + str(strategy))			
