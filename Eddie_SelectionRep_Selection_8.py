...
if not os.path.isdir(scenario + str(rep) + str(8)):
	os.makedirs(scenario + str(rep) + str(8))
SelectionDir = scenario + str(rep) + str(8)+ "/"
...
os.system('cp -r ' + WorkingDir + '/FillInBurnIn' + str(rep) + str(8)+ '/* .')
