...
VarE = matrix(data = c(3, 0.0, 0.0, 3), nrow = 2); cov2cor(VarE)
...
for (Generation in 1:nGenerationEval) {
  ...
  blup1dat$ProgramGen <- paste0(blup1dat$Program, blup1dat$Generation)
  ...
  blup2dat$ProgramGen <- paste0(blup2dat$Program, blup2dat$Generation)
...
PedEval1 <- PedEval1[PedEval1$Generation !=0,]
...
Part1$EbvT1_s <- Part1$EbvT1_s[Part1$EbvT1_s$Program == "PN1",]
Part1$EbvT2_s <- Part1$EbvT2_s[Part1$EbvT2_s$Program == "PN1",]
Part1$EbvI_s <- Part1$EbvI_s[Part1$EbvI_s$Program == "PN1",]
Part1$EbvT1_s <- Part1$EbvT1_s[Part1$EbvT1_s$Program == "GN",]
Part1$EbvT2_s <- Part1$EbvT2_s[Part1$EbvT2_s$Program == "GN",]
Part1$EbvI_s <- Part1$EbvI_s[Part1$EbvI_s$Program == "GN",]

Part2$EbvT1_s <- Part2$EbvT1_s[Part2$EbvT1_s$Program == "PN2",]
Part2$EbvT2_s <- Part2$EbvT2_s[Part2$EbvT2_s$Program == "PN2",]
Part2$EbvI_s <- Part2$EbvI_s[Part2$EbvI_s$Program == "PN2",]
...
PedEval1$PAEbv1 <- 0.5 * (PedEval1$F_TbvT1 + PedEval1$M_EbvT1)
PedEval1$PAEbv2 <- 0.5 * (PedEval1$F_TbvT2 + PedEval1$M_EbvT2)
