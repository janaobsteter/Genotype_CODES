...
for rep in range(0, int(rep)+1):
	...
	ks.loc[ks.Generation.isin(range(max(ks.Generation)-6, max(ks.Generation)+1)), 'Indiv'].to_csv('/home/v1jobste/JanaO/FillInBurnIn' + str(rep) + '/IndForGeno_10000.txt', index=None, header=None, sep='\n')
