...
- zipSubDir = zips the six files (FinalReport, LocusSummary, LocusXDNA, SampleMap, SNPMap, DNAReport) into one zip file named after the directory and removes the directory)
