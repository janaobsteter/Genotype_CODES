...
r_genomic_correction <- function(h2, N, Me) {
  acc = sqrt((h2 * N) / (h2 * N + Me))
  accNew = acc + ((acc**4 * Me)/ (2 * N))
  return(accNew)
}



r_genomic(0.79, 10000, 10000)
r_genomic(0.67, 10000, 10000)
r_genomic(0.49, 10000, 10000)
r_genomic(0.38, 10000, 10000)
r_genomic_correction(0.79, 10000, 10000)
r_genomic_correction(0.67, 10000, 10000)
r_genomic_correction(0.49, 10000, 10000)
r_genomic_correction(0.38, 10000, 10000)

r_genomic_correction(0.89**2, 10000, 10000)
r_genomic_correction(0.82**2, 20000, 10000)
r_genomic_correction(0.71**2, 50000, 10000)
r_genomic_correction(0.63**2, 100000, 10000)
